function [predict_label,prob_values] = svmClassification_All_image(trainData,trainLabels,image_vec,r,c)
            ...
            testLabels = zeros(size(image_vec,1),1);
            [predict_label, accuracy, prob_values] = libsvmpredict(testLabels, image_vec, model); % run the SVM model on the test data
